...
public interface ShiftSolverServiceAsync {
	...
	void saveEmployee(Employee employee, AsyncCallback<Employee> callback);
	...
	void savePeriodPreferences(PeriodPreferences periodPreferences, AsyncCallback<PeriodPreferences> callback);
	...
	void savePeriodSolution(PeriodSolution periodSolution, AsyncCallback<PeriodSolution> callback);
